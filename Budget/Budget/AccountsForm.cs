...
namespace Budget
{
    public partial class AccountsForm : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'mainDataSet.BudgetAccount' table. You can move, or remove it, as needed.
            this.budgetAccountTableAdapter.Fill(this.mainDataSet.BudgetAccount);
        ...
        {
            budgetAccountTableAdapter.Update(this.mainDataSet.BudgetAccount);
        }
    }
}
