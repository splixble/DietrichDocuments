...
namespace WebCoreSongs.Controllers
{
    public class ViewsongperformancetotalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Total,SongId,TitleAndArtist,FirstPerformed,LastPerformed,RowNum")] Viewsongperformancetotals viewsongperformancetotals)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Total,SongId,TitleAndArtist,FirstPerformed,LastPerformed,RowNum")] Viewsongperformancetotals viewsongperformancetotals)
        {
