...
namespace WebCoreSongs.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ArtistFirstName,ArtistLastName,ArtistId")] Artists artists)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ArtistFirstName,ArtistLastName,ArtistId")] Artists artists)
        {
